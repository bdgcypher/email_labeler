      ...
      <div>
        ...
        <div className="hidden lg:flex lg:w-64 lg:flex-col lg:fixed lg:inset-y-0">
          ...
          <div className="flex-1 flex flex-col min-h-0 bg-gray-800">
            ...
            <div className="flex-shrink-0 flex border-t-2 border-gray-700 bg-gray-800 p-4">
              <a href="/" className="flex-shrink-0 w-full group block">
                <div className="flex items-center">
                  <div className="ml-3">
                    <p className="text-sm font-medium text-white">Tom Cook</p>
                    <p className="text-xs font-medium text-gray-400 group-hover:text-gray-200">Logout</p>
                  </div>
                </div>
              </a>
            </div>
        ...
        <div className="lg:pl-64 flex flex-col flex-1">
          <div className="sticky top-0 z-11 lg:hidden pt-1 sm:pl-3 sm:pt-3 bg-gray-100">
            <button
              type="button"
