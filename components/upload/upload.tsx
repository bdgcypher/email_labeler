...
import UploadSuccessful from '../dashboard/upload_successful';
import UploadError from '../dashboard/upload_error';
import UploadProgress from '../dashboard/upload_progress';
